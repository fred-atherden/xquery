...
for $x in $s//(*:report[@id=$ids]|*:assert[@id=$ids])
let $url := ('see="https://elifesciences.gitbook.io/productionhowto/-M1eY9ikxECYR-0OcnGt/article-details/content/article-structure#'||$x/@id||'"&#xa;')
return $url